...
def from_batch_preloaded(tool_names: list[str]):
    # response = {
    #     'tools': [],
    #     'tool_info': []
    # }
    ...
    for tool_name in tool_names:
        ...
        tool = AutoTool.from_preloaded(tool_name, True)
        tools.append(tool)
...
class SearchAgent:
    def __init__(self, agent_name):
        ...
        self.tools = [
            ...
            for tool in from_batch_preloaded(self.config["tools"])
        ]
    ...
    def build_system_instruction(self):
        ...
        plan_instruction = "".join(
            [
                ...
                "[" "[",
                '{"action_type": "tool_use", "action": "gather information from wikipedia. ", "tool_use": ["arxiv"]},',
    ...
    def manual_workflow(self):
        workflow = [
            ...
            },
            {
                ...
                "action": "Provide summerized responses based on the user's query. Response should be very short.",
                "tool_use": [],
            },
        ]
        return workflow
